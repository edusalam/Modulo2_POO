#SE CREARA UN SISTEMA PARA CALCULAR DESCUENTOS
...
class Pedido:
     def __init__(self, monto, estrategiDescuento: EstrategiaDescuento):
          self.monto = monto
          self.estrategiaDescuento = estrategiDescuento
